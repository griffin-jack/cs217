...
extern "C" {
#endif
void  rmaPropagate0_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate0_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate0_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate1_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate1_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate2_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate2_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate3_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate3_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate4_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate4_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate5_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate5_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate6_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate6_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate7_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate7_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate8_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate8_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate16_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate16_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate18_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate18_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate23_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate23_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate25_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate25_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate25_t0_sc_mainpwr_daidir (UB  * pcode, UB  val);
void  rmaPropagate25_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate26_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate26_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate26_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate32_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate35_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate35_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate35_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate36_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate36_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate36_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate38_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate38_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate39_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate39_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate39_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
