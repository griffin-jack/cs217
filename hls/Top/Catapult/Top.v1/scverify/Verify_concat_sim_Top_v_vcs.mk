...
# Generated date: Wed Mar 18 19:39:25 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   PROJECT_HOME  /home/users/code/cs217/hls/Top
#   SOLUTION_DIR  /home/users/code/cs217/hls/Top/Catapult/Top.v1
#   WORKING_DIR   /home/users/code/cs217/hls/Top/Catapult/Top.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult/Top.v1
PROJ2SOLN = ./Catapult/Top.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_Top.v/concat_sim_Top.v.vts
endif
endif
...
VHDL_SRC += 
VLOG_SRC += ./concat_sim_Top.v/concat_sim_Top.v.vts ./scverify/ccs_wrapper_Top.v/ccs_wrapper_Top.v.vts
endif
CXX_SRC  = ../../../../src/Top/testbench.cpp/testbench.cpp.cxxts ./scverify/sysc_sim.cpp/sysc_sim.cpp.cxxts
...
$(TARGET)/concat_sim_Top.v.vts: ./concat_sim_Top.v
$(TARGET)/ccs_wrapper_Top.v.vts: ./scverify/ccs_wrapper_Top.v
$(TARGET)/testbench.cpp.cxxts: ../../../../src/Top/testbench.cpp
...
$(TARGET)/concat_sim_Top.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
