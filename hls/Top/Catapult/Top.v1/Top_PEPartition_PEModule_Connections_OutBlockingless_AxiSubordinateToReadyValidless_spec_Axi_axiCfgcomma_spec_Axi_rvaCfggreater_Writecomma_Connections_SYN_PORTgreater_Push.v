...
//  Generated date: Wed Mar 18 18:52:07 2026
// ----------------------------------------------------------------------

//
// ------------------------------------------------------------------
//  Design Unit:    Connections_OutBlockingless_AxiSubordinateToReadyValidless_spec_Axi_axiCfgcomma_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_Connections_OutBlocking_AxiSubordinateToReadyValid_spec_Axi_axiCfg_spec_Axi_rvaCfg000000
// ------------------------------------------------------------------


module Top_PEPartition_PEModule_Connections_OutBlockingless_AxiSubordinateToReadyValidless_spec_Axi_axiCfgcomma_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_Connections_OutBlocking_AxiSubordinateToReadyValid_spec_A000000
    (
  ...
  assign nl_ccs_ccore_done_synci_ivld = io_read_ccs_ccore_start_rsc_sft_lpi_1_dfm_1
      & this_rdy;
  Top_PEPartition_PEModule_Connections_OutBlockingless_AxiSubordinateToReadyValidless_spec_Axi_axiCfgcomma_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_ccs_in_v1
      #(.rscid(32'sd7),
  ...
  Top_PEPartition_PEModule_Connections_OutBlockingless_AxiSubordinateToReadyValidless_spec_Axi_axiCfgcomma_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_ccs_sync_out_vld_v1
      #(.rscid(32'sd237)) ccs_ccore_done_synci (
...
// ------------------------------------------------------------------
//  Design Unit:    Connections_OutBlocking_AxiSubordinateToReadyValid_spec_Axi_axiCfg_spec_Axi_rvaCfg_Write_Connections_SYN_PORT_Push
// ------------------------------------------------------------------


module Top_PEPartition_PEModule_Connections_OutBlocking_AxiSubordinateToReadyValid_spec_Axi_axiCfg_spec_Axi_rvaCfg_Write_Connections_SYN_PORT_Push
    (
  this_vld, this_rdy, this_dat, m_data_rsc_dat, m_addr_rsc_dat, m_wstrb_rsc_dat,
      m_rw_rsc_dat, ccs_ccore_start_rsc_dat, ccs_ccore_done_sync_vld, ccs_MIO_clk,
      ccs_MIO_arst
  ...
  // Interconnect Declarations for Component Instantiations
  Top_PEPartition_PEModule_Connections_OutBlockingless_AxiSubordinateToReadyValidless_spec_Axi_axiCfgcomma_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_Connections_OutBlocking_AxiSubordinateToReadyValid_spec_A000000
      Connections_OutBlocking_AxiSubordinateToReadyValid_spec_Axi_axiCfg_spec_Axi_rvaCfg_Write_Connections_SYN_PORT_Push_core_inst
      (
      .this_vld(this_vld),
      .this_rdy(this_rdy),
      .this_dat(this_dat),
