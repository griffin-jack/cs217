...
//  Generated date: Wed Mar 18 17:12:42 2026
// ----------------------------------------------------------------------
...
module Top_PEPartition_PEModule_ActUnit_Connections_OutBlockingless_spec_StreamTypecomma_Connections_SYN_PORTgreater_Push_Connections_OutBlocking_spec_StreamType_Connections_SYN_PORT_Push_core
    (
  ...
  assign nl_ccs_ccore_done_synci_ivld = io_read_ccs_ccore_start_rsc_sft_lpi_1_dfm_1
      & this_rdy;
  Top_PEPartition_PEModule_ActUnit_Connections_OutBlockingless_spec_StreamTypecomma_Connections_SYN_PORTgreater_Push_ccs_in_v1
      #(.rscid(32'sd15),
  ...
  Top_PEPartition_PEModule_ActUnit_Connections_OutBlockingless_spec_StreamTypecomma_Connections_SYN_PORTgreater_Push_ccs_sync_out_vld_v1
      #(.rscid(32'sd76)) ccs_ccore_done_synci (
...
module Top_PEPartition_PEModule_ActUnit_Connections_OutBlocking_spec_StreamType_Connections_SYN_PORT_Push (
  this_vld, this_rdy, this_dat, m_data_data_rsc_dat, m_logical_addr_rsc_dat, ccs_ccore_start_rsc_dat,
      ccs_ccore_done_sync_vld, ccs_MIO_clk, ccs_MIO_arst
);
  output this_vld;
  ...
  // Interconnect Declarations for Component Instantiations
  Top_PEPartition_PEModule_ActUnit_Connections_OutBlockingless_spec_StreamTypecomma_Connections_SYN_PORTgreater_Push_Connections_OutBlocking_spec_StreamType_Connections_SYN_PORT_Push_core
