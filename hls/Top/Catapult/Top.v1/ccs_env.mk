ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /cad/mentor/2024.2_1/Mgc_home/pkgs/dcs_gcc/usr
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /cad/mentor/2021.4/questasim/bin
...
Novas_NOVAS_INST_DIR                                := /cad/synopsys/verdi/V-2023.12-SP2-4
...
ifeq "$(VCS_VCS_HOME)" ""
VCS_VCS_HOME                                        := /cad/synopsys/vcs/U-2023.03
export VCS_VCS_HOME
endif
...
VCS_VG_GNU_PACKAGE                                  := /cad/synopsys/vcs_gnu_package/S-2021.09/gnu_9/linux
...
ifeq "$(INLINED_PROPERTY_CHECKS)" ""
INLINED_PROPERTY_CHECKS                             := true
export INLINED_PROPERTY_CHECKS
endif
...
ifeq "$(COMPILERFLAGS)" ""
COMPILERFLAGS                                       := -D_SYNTHESIS_ -DHLS_CATAPULT -DHLS_ALGORITHMICC -DCONNECTIONS_ACCURATE_SIM -DSC_INCLUDE_DYNAMIC_PROCESSES 
