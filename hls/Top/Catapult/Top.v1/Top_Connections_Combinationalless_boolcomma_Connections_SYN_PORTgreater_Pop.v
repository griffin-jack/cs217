...
//  Generated date: Wed Mar 18 19:33:22 2026
// ----------------------------------------------------------------------

//
// ------------------------------------------------------------------
//  Design Unit:    Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_Connections_Combinational_bool_Connections_SYN_PORT_Pop_core
// ------------------------------------------------------------------


module Top_Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_Connections_Combinational_bool_Connections_SYN_PORT_Pop_core
    (
  ...
  assign nl_ccs_ccore_done_synci_ivld = io_read_ccs_ccore_start_rsc_sft_lpi_1_dfm_1
      & this_vld;
  Top_Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_ccs_in_v1
      #(.rscid(32'sd502),
  .width(32'sd1)) ccs_ccore_start_rsci (
      .dat(ccs_ccore_start_rsc_dat),
      .idat(ccs_ccore_start_rsci_idat)
    );
  Top_Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_ccs_sync_out_vld_v1
      #(.rscid(32'sd519)) ccs_ccore_done_synci (
...
module Top_Connections_Combinational_bool_Connections_SYN_PORT_Pop (
  ...
  // Interconnect Declarations for Component Instantiations
  Top_Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_Connections_Combinational_bool_Connections_SYN_PORT_Pop_core
      Connections_Combinational_bool_Connections_SYN_PORT_Pop_core_inst (
      .this_vld(this_vld),
      .this_rdy(this_rdy),
