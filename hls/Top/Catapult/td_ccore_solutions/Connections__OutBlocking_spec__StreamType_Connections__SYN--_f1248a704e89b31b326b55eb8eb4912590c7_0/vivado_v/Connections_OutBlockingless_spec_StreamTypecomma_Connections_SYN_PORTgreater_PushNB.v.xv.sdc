...
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_data_data_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_index_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_logical_addr_rsc_dat[*]}]
