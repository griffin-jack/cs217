...
module Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_Connections_Combinational_bool_Connections_SYN_PORT_Pop_core
    (
  ...
  assign nl_ccs_ccore_done_synci_ivld = io_read_ccs_ccore_start_rsc_sft_lpi_1_dfm_1
      & this_vld;
  Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_ccs_in_v1
      #(.rscid(32'sd502),
  .width(32'sd1)) ccs_ccore_start_rsci (
      .dat(ccs_ccore_start_rsc_dat),
      .idat(ccs_ccore_start_rsci_idat)
    );
  Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_ccs_sync_out_vld_v1
...
module Connections_Combinational_bool_Connections_SYN_PORT_Pop (
  ...
  // Interconnect Declarations for Component Instantiations 
  Connections_Combinationalless_boolcomma_Connections_SYN_PORTgreater_Pop_Connections_Combinational_bool_Connections_SYN_PORT_Pop_core
