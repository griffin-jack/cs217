...
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_id_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_data_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_resp_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_last_rsc_dat}]
