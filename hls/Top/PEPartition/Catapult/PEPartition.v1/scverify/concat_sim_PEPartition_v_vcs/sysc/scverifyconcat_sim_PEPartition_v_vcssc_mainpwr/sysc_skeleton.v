...
//  Verilog wrapper module for SystemC instance 'sc_main.tb.manager'
`noinline
...
(*vcs_systemc_2,vcs_systemc_skel*) module \sysc$CCS_RTL::sysc_sim_wrapper ;
  ...
  reg \ccs_rtl_R_input_port_vld ;
  reg [137:0] \ccs_rtl_R_input_port_dat ;
  reg \ccs_rtl_R_output_port_rdy ;
  ...
  ccs_wrapper  ccs_rtl (
     ...
     .input_port_vld(\ccs_rtl_R_input_port_vld ),
     .input_port_dat(\ccs_rtl_R_input_port_dat ),
     .output_port_rdy(\ccs_rtl_R_output_port_rdy ),
  ...
  //  signal:  ccs_rtl_SIG_input_port_vld
  //  signal:  ccs_rtl_SIG_input_port_rdy
  //  signal:  ccs_rtl_SIG_input_port_dat
  //  signal:  ccs_rtl_SIG_output_port_vld
  //  signal:  ccs_rtl_SIG_output_port_rdy
  //  signal:  ccs_rtl_SIG_output_port_dat
...
(*vcs_systemc_2,vcs_systemc_skel*) module sysc$testbench;
  ...
  //  instance:  manager (BF_MODULE_T)
  \sysc$ManagerFromFile<spec::Axi::axiCfg,...>  manager();
...
// use sc_main.tb.manager \sysc$ManagerFromFile<spec::Axi::axiCfg,...> 
