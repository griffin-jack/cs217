...
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {act_port_vld}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {act_port_rdy}]
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {act_port_dat[*]}]
...
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {output_port_vld}]
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {output_port_rdy}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {output_port_dat[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {done_vld}]
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {done_rdy}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {done_dat}]
