# ----------------------------------------------------------------------------
# Concat concat_sim_ActUnit Verilog
#
...
# Generated date: Wed Mar 18 17:18:32 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_ActUnit
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = vcs
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_ActUnit.v/concat_sim_ActUnit.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_ActUnit.v/ccs_wrapper_ActUnit.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_ActUnit.v/concat_sim_ActUnit.v.vts ./scverify/ccs_wrapper_ActUnit.v/ccs_wrapper_ActUnit.v.vts
endif
...
$(TARGET)/concat_sim_ActUnit.v.vts: ./concat_sim_ActUnit.v
...
$(TARGET)/concat_sim_ActUnit.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
