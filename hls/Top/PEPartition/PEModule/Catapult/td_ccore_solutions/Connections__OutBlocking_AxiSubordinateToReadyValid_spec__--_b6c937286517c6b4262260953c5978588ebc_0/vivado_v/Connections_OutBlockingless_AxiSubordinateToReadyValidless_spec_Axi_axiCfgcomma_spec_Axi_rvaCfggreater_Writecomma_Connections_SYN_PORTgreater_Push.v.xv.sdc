...
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_addr_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_wstrb_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_rw_rsc_dat}]
