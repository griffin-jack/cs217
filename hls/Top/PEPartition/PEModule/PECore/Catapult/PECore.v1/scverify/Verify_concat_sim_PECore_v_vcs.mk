# ----------------------------------------------------------------------------
# Concat concat_sim_PECore Verilog
#
...
# Generated date: Wed Mar 18 18:46:20 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_PECore
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = vcs
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_PECore.v/concat_sim_PECore.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_PECore.v/ccs_wrapper_PECore.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_PECore.v/concat_sim_PECore.v.vts ./scverify/ccs_wrapper_PECore.v/ccs_wrapper_PECore.v.vts
endif
...
$(TARGET)/concat_sim_PECore.v.vts: ./concat_sim_PECore.v
...
$(TARGET)/concat_sim_PECore.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
