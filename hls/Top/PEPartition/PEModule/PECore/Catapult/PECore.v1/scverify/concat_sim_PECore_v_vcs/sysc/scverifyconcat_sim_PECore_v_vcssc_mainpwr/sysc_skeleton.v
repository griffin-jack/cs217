...
//  already present as module \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Write,...> 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.dummyPortManager_7'
//  already present as module \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Write,...>::DummyPortManager 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.comb_ba_8'
//  already present as module \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Read,...> 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.dummyPortManager_8'
//  already present as module \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Read,...>::DummyPortManager 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.comb_ba_9'
//  already present as module \sysc$Connections::Combinational<nvhls::nv_scvector<ac_int<16,...>,...>,...> 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.dummyPortManager_9'
//  already present as module \sysc$Connections::Combinational<nvhls::nv_scvector<ac_int<16,...>,...>,...>::DummyPortManager 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.comb_ba_10'
//  already present as module \sysc$Connections::Combinational<spec::StreamType,...> 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.dummyPortManager_10'
//  already present as module \sysc$Connections::Combinational<spec::StreamType,...>::DummyPortManager 


//  Verilog wrapper module for SystemC instance 'sc_main.tb.act_inst'
`noinline
...
//  Verilog wrapper module for SystemC instance 'sc_main.tb.pe_inst'
`noinline
(*vcs_systemc_2,vcs_systemc_skel*) module sysc$PECore;
...
(*vcs_systemc_2,vcs_systemc_skel*) module sysc$Testbench;
  ...
  \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Write,...>  comb_ba_7();

  //  instance:  dummyPortManager_7 (BF_MODULE_T)
  \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Write,...>::DummyPortManager  dummyPortManager_7();

  //  instance:  comb_ba_8 (BF_MODULE_T)
  \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Read,...>  comb_ba_8();

  //  instance:  dummyPortManager_8 (BF_MODULE_T)
  \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Read,...>::DummyPortManager  dummyPortManager_8();

  //  instance:  comb_ba_9 (BF_MODULE_T)
  \sysc$Connections::Combinational<nvhls::nv_scvector<ac_int<16,...>,...>,...>  comb_ba_9();

  //  instance:  dummyPortManager_9 (BF_MODULE_T)
  \sysc$Connections::Combinational<nvhls::nv_scvector<ac_int<16,...>,...>,...>::DummyPortManager  dummyPortManager_9();

  //  instance:  comb_ba_10 (BF_MODULE_T)
  \sysc$Connections::Combinational<spec::StreamType,...>  comb_ba_10();

  //  instance:  dummyPortManager_10 (BF_MODULE_T)
  \sysc$Connections::Combinational<spec::StreamType,...>::DummyPortManager  dummyPortManager_10();

  //  instance:  act_inst (BF_MODULE_T)
  sysc$ActUnit act_inst();

  //  instance:  pe_inst (BF_MODULE_T)
  sysc$PECore pe_inst();
  ...
  //  signal:  comb_in_vld_10
  //  signal:  comb_in_rdy_10
  //  signal:  comb_out_vld_10
  //  signal:  comb_out_rdy_10
  //  signal:  comb_in_dat_10
  //  signal:  comb_out_dat_10
  //  signal:  signal_1
  //  port:  sim_out_0_vld
  //  port:  sim_out_0_rdy
  //  port:  sim_out_0_dat
...
// use sc_main.tb.comb_ba_7 \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Write,...> 
// use sc_main.tb.dummyPortManager_7 \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Write,...>::DummyPortManager 
// use sc_main.tb.comb_ba_8 \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Read,...> 
// use sc_main.tb.dummyPortManager_8 \sysc$Connections::Combinational<RVSink<spec::Axi::rvaCfg>::Read,...>::DummyPortManager 
// use sc_main.tb.comb_ba_9 \sysc$Connections::Combinational<nvhls::nv_scvector<ac_int<16,...>,...>,...> 
// use sc_main.tb.dummyPortManager_9 \sysc$Connections::Combinational<nvhls::nv_scvector<ac_int<16,...>,...>,...>::DummyPortManager 
// use sc_main.tb.comb_ba_10 \sysc$Connections::Combinational<spec::StreamType,...> 
// use sc_main.tb.dummyPortManager_10 \sysc$Connections::Combinational<spec::StreamType,...>::DummyPortManager 
// use sc_main.tb.act_inst sysc$ActUnit
// use sc_main.tb.pe_inst sysc$PECore
