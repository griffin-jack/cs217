# ----------------------------------------------------------------------------
# Concat concat_sim_GBPartition Verilog
#
...
# Generated date: Wed Mar 18 19:24:56 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   PROJECT_HOME  /home/users/code/cs217/hls/Top/GBPartition
#   SOLUTION_DIR  /home/users/code/cs217/hls/Top/GBPartition/Catapult/GBPartition.v1
#   WORKING_DIR   /home/users/code/cs217/hls/Top/GBPartition/Catapult/GBPartition.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult/GBPartition.v1
PROJ2SOLN = ./Catapult/GBPartition.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_GBPartition
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = vcs
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_GBPartition.v/concat_sim_GBPartition.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_GBPartition.v/ccs_wrapper_GBPartition.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_GBPartition.v/concat_sim_GBPartition.v.vts ./scverify/ccs_wrapper_GBPartition.v/ccs_wrapper_GBPartition.v.vts
endif
CXX_SRC  = ../../../../../src/Top/GBPartition/testbench.cpp/testbench.cpp.cxxts ./scverify/sysc_sim.cpp/sysc_sim.cpp.cxxts
...
$(TARGET)/concat_sim_GBPartition.v.vts: ./concat_sim_GBPartition.v
$(TARGET)/ccs_wrapper_GBPartition.v.vts: ./scverify/ccs_wrapper_GBPartition.v
$(TARGET)/testbench.cpp.cxxts: ../../../../../src/Top/GBPartition/testbench.cpp
...
$(TARGET)/ccs_wrapper_GBPartition.v.vts: HDL_LIB=work
$(TARGET)/concat_sim_GBPartition.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/ccs_wrapper_GBPartition.v.vts: VLOG_F_OPTS=
$(TARGET)/concat_sim_GBPartition.v.vts: VLOG_F_OPTS=
$(TARGET)/ccs_wrapper_GBPartition.v.vts: NCVLOG_F_OPTS=
$(TARGET)/concat_sim_GBPartition.v.vts: NCVLOG_F_OPTS=
$(TARGET)/ccs_wrapper_GBPartition.v.vts: VCS_F_OPTS=
$(TARGET)/concat_sim_GBPartition.v.vts: VCS_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/ccs_wrapper_GBPartition.v.vts: DUT_E=ccs_wrapper
$(TARGET)/concat_sim_GBPartition.v.vts: DUT_E=GBPartition

# Specify top design unit
$(TARGET)/ccs_wrapper_GBPartition.v.vts: VLOG_TOP=1
