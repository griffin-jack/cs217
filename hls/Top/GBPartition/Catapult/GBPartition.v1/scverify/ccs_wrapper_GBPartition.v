...
module ccs_wrapper (
  clk, rst, gb_done_vld, gb_done_rdy, gb_done_dat, if_axi_rd_ar_vld, if_axi_rd_ar_rdy, if_axi_rd_ar_dat, if_axi_rd_r_vld,
      if_axi_rd_r_rdy, if_axi_rd_r_dat, if_axi_wr_aw_vld, if_axi_wr_aw_rdy, if_axi_wr_aw_dat, if_axi_wr_w_vld,
      if_axi_wr_w_rdy, if_axi_wr_w_dat, if_axi_wr_b_vld, if_axi_wr_b_rdy, if_axi_wr_b_dat, data_in_vld, data_in_rdy,
      data_in_dat, data_out_vld, data_out_rdy, data_out_dat, pe_start_vld, pe_start_rdy, pe_start_dat, pe_done_vld,
      pe_done_rdy, pe_done_dat
);
  input clk;
  input rst;
  output gb_done_vld;
