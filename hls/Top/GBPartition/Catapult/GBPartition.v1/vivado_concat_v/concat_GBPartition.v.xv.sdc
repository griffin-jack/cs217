...
set_input_delay 0.0 -clock virtual_io_clk [get_ports {data_in_vld}]
set_output_delay 0.0 -clock virtual_io_clk [get_ports {data_in_rdy}]
set_input_delay 0.0 -clock virtual_io_clk [get_ports {data_in_dat[*]}]
set_output_delay 0.0 -clock virtual_io_clk [get_ports {data_out_vld}]
set_input_delay 0.0 -clock virtual_io_clk [get_ports {data_out_rdy}]
set_output_delay 0.0 -clock virtual_io_clk [get_ports {data_out_dat[*]}]
set_output_delay 0.0 -clock virtual_io_clk [get_ports {pe_start_vld}]
set_input_delay 0.0 -clock virtual_io_clk [get_ports {pe_start_rdy}]
set_output_delay 0.0 -clock virtual_io_clk [get_ports {pe_start_dat}]
set_input_delay 0.0 -clock virtual_io_clk [get_ports {pe_done_vld}]
set_output_delay 0.0 -clock virtual_io_clk [get_ports {pe_done_rdy}]
set_input_delay 0.0 -clock virtual_io_clk [get_ports {pe_done_dat}]
