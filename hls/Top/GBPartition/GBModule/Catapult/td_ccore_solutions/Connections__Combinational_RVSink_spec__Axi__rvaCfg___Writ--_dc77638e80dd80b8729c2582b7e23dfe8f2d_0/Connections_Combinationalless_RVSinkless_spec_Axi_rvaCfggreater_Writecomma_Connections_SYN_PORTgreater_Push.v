...
module Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_Connections_Combinational_RVSink_spec_Axi_rvaCfg_Write_Connections_SYN_PORT_Push_core
    (
  ...
  assign nl_ccs_ccore_done_synci_ivld = io_read_ccs_ccore_start_rsc_sft_lpi_1_dfm_1
      & this_rdy;
  Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_ccs_in_v1
      #(.rscid(32'sd158),
  ...
  Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_ccs_sync_out_vld_v1
...
module Connections_Combinational_RVSink_spec_Axi_rvaCfg_Write_Connections_SYN_PORT_Push
    (
  this_vld, this_rdy, this_dat, m_data_rsc_dat, m_addr_rsc_dat, m_wstrb_rsc_dat,
      m_rw_rsc_dat, ccs_ccore_start_rsc_dat, ccs_ccore_done_sync_vld, ccs_MIO_clk,
      ccs_MIO_arst
  ...
  // Interconnect Declarations for Component Instantiations 
  Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Writecomma_Connections_SYN_PORTgreater_Push_Connections_Combinational_RVSink_spec_Axi_rvaCfg_Write_Connections_SYN_PORT_Push_core
