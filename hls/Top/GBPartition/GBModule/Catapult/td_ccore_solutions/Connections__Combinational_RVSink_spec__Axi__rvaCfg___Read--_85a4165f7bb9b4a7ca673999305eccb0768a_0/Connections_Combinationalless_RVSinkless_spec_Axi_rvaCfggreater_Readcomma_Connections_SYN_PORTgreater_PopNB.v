...
module Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Readcomma_Connections_SYN_PORTgreater_PopNB_Connections_Combinational_RVSink_spec_Axi_rvaCfg_Read_Connections_SYN_PORT_PopNB_core
    (
  ...
  Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Readcomma_Connections_SYN_PORTgreater_PopNB_mgc_out_dreg_v2
      #(.rscid(32'sd163),
  ...
  Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Readcomma_Connections_SYN_PORTgreater_PopNB_ccs_in_v1
      #(.rscid(32'sd186),
...
module Connections_Combinational_RVSink_spec_Axi_rvaCfg_Read_Connections_SYN_PORT_PopNB
    (
  this_vld, this_rdy, this_dat, data_data_rsc_z, return_rsc_z, ccs_ccore_start_rsc_dat,
      ccs_MIO_clk, ccs_MIO_arst
);
  ...
  // Interconnect Declarations for Component Instantiations 
  Connections_Combinationalless_RVSinkless_spec_Axi_rvaCfggreater_Readcomma_Connections_SYN_PORTgreater_PopNB_Connections_Combinational_RVSink_spec_Axi_rvaCfg_Read_Connections_SYN_PORT_PopNB_core
