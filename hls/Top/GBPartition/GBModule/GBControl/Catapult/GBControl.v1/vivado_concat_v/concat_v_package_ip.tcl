...
set RTL_TOOL_SCRIPT_DIR /home/users/code/cs217/hls/Top/GBPartition/GBModule/GBControl/Catapult/GBControl.v1/vivado_concat_v
...
puts "==========================================="
set outputDir /home/users/code/cs217/hls/Top/GBPartition/GBModule/GBControl/Catapult/GBControl.v1/vivado_concat_v
set outputDir $RTL_TOOL_SCRIPT_DIR
create_project -force ip_tcl_concat_v
   read_verilog ../concat_GBControl.v
# set up XPM libraries for XPM-related IP like the Catapult Xilinx_FIFO
set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY XPM_FIFO} [current_project]
read_xdc $outputDir/concat_GBControl.v.xv.sdc
