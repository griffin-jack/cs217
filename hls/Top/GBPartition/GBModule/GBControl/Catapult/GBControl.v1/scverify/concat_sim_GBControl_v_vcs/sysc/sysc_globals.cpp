...
extern "C" {
  ...
  int sysc_use_hdl_timeres = 0;
  int sysc_diag = 0;
  int snps_systemc_version = 233;
  int sysc_donut = 0;
  int sysc_only = 0;
  int sysc_new_sync = 0;
  int sysc_skeleton = 1;
  int sysc_show_sc_main = 1;
  int is_mx_design = 0;
  ...
  const char *sysc_compiler_prefix = "gcc9";
  const char *sysc_mlib = "";
  const char *sysc_mdir = "scverify/concat_sim_GBControl_v_vcs";
  const char *sysc_top_module_name = "sc_main";
  const char *linklibs = "";
  const char *sysc_tool_home = "/cad/synopsys/vcs/U-2023.03/linux64";
  const char *sysc_sdf_annotate = " ";
  const char *sysc_vcsi_home_internal = "";
  const char *sysc_vcs_cosim_output_directory = "scverify/concat_sim_GBControl_v_vcs";
  const char *sysc_make_dir = "/home/users/code/cs217/hls/Top/GBPartition/GBModule/GBControl/Catapult/GBControl.v1/scverify/concat_sim_GBControl_v_vcs";
  const char *sysc_top = "scverify/concat_sim_GBControl_v_vcs/sysc/scverifyconcat_sim_GBControl_v_vcssc_mainpwr";
  const char *sysc_pwd = "/home/users/code/cs217/hls/Top/GBPartition/GBModule/GBControl/Catapult/GBControl.v1";
  const char *_sysc_cpp = "/cad/synopsys/vcs_gnu_package/S-2021.09/gnu_9/linux/gcc-9.2.0_64-shared/bin/g++";
  const char *_sysc_as = "/cad/synopsys/vcs_gnu_package/S-2021.09/gnu_9/linux/binutils-2.33.1_64/bin/as";
  const char *sysc_md5_checksum = "f2ece72b061ff3e461d7520bbbb863fe";
  const char *sysc_arch = "linux64";
  const char *sysc_output = "/home/users/code/cs217/hls/Top/GBPartition/GBModule/GBControl/Catapult/GBControl.v1/scverify/concat_sim_GBControl_v_vcs/sc_mainpwr";
