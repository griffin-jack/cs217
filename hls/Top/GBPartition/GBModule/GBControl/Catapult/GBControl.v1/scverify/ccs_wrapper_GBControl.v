...
module ccs_wrapper (
  clk, rst, rva_in_vld, rva_in_rdy, rva_in_dat, rva_out_vld, rva_out_rdy, rva_out_dat, start_vld, start_rdy, start_dat,
      ...
      large_rsp_dat, data_out_vld, data_out_rdy, data_out_dat, data_in_vld, data_in_rdy, data_in_dat, pe_start_vld,
      pe_start_rdy, pe_start_dat, pe_done_vld, pe_done_rdy, pe_done_dat
);
  input clk;
  input rst;
  input rva_in_vld;
