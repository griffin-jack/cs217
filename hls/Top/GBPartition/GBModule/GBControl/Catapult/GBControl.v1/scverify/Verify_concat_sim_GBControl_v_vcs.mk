# ----------------------------------------------------------------------------
# Concat concat_sim_GBControl Verilog
#
...
# Generated date: Wed Mar 18 19:16:20 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_GBControl
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = vcs
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_GBControl.v/concat_sim_GBControl.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_GBControl.v/ccs_wrapper_GBControl.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_GBControl.v/concat_sim_GBControl.v.vts ./scverify/ccs_wrapper_GBControl.v/ccs_wrapper_GBControl.v.vts
endif
...
$(TARGET)/concat_sim_GBControl.v.vts: ./concat_sim_GBControl.v
...
$(TARGET)/concat_sim_GBControl.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/concat_sim_GBControl.v.vts: VLOG_F_OPTS=
$(TARGET)/ccs_wrapper_GBControl.v.vts: NCVLOG_F_OPTS=
$(TARGET)/concat_sim_GBControl.v.vts: NCVLOG_F_OPTS=
$(TARGET)/ccs_wrapper_GBControl.v.vts: VCS_F_OPTS=
$(TARGET)/concat_sim_GBControl.v.vts: VCS_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/ccs_wrapper_GBControl.v.vts: DUT_E=ccs_wrapper
$(TARGET)/concat_sim_GBControl.v.vts: DUT_E=GBControl
