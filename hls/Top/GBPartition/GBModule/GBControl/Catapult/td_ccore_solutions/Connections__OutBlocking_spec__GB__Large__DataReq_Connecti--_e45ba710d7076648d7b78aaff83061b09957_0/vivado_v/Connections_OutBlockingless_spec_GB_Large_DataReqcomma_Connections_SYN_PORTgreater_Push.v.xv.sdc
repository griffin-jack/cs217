...
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_is_write_rsc_dat}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_memory_index_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_vector_index_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_timestep_index_rsc_dat[*]}]
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {m_write_data_data_rsc_dat[*]}]
