...
module Connections_InBlockingless_spec_GB_Large_DataRspless_1Ugreater_comma_Connections_SYN_PORTgreater_PopNB_Connections_InBlocking_spec_GB_Large_DataRsp_1U_Connections_SYN_PORT_PopNB_core
    (
  ...
  Connections_InBlockingless_spec_GB_Large_DataRspless_1Ugreater_comma_Connections_SYN_PORTgreater_PopNB_mgc_out_dreg_v2
      #(.rscid(32'sd16),
  ...
  Connections_InBlockingless_spec_GB_Large_DataRspless_1Ugreater_comma_Connections_SYN_PORTgreater_PopNB_ccs_in_v1
      #(.rscid(32'sd46),
...
module Connections_InBlocking_spec_GB_Large_DataRsp_1U_Connections_SYN_PORT_PopNB
    (
  this_vld, this_rdy, this_dat, data_read_vector_data_data_rsc_z, return_rsc_z, ccs_ccore_start_rsc_dat,
      ccs_MIO_clk, ccs_MIO_arst
);
  ...
  // Interconnect Declarations for Component Instantiations 
  Connections_InBlockingless_spec_GB_Large_DataRspless_1Ugreater_comma_Connections_SYN_PORTgreater_PopNB_Connections_InBlocking_spec_GB_Large_DataRsp_1U_Connections_SYN_PORT_PopNB_core
