...
void  rmaPropagate14_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate14_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate14_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_sc_mainpwr_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_f_sc_mainpwr_daidir (UB  * pcode, scalar  val, U  I616, scalar  * I1418, U  did);
void  rmaPropagate15_r_sc_mainpwr_daidir (UB  * pcode);
void  rmaPropagate15_wn_sc_mainpwr_daidir (UB  * pcode, scalar  val);
...
void  rmaPropagate26_t0_sc_mainpwr_daidir (UB  * pcode, UB  val);
