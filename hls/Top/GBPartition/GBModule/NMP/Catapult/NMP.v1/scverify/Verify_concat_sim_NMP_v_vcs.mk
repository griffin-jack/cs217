...
# Generated date: Wed Mar 18 19:10:15 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_NMP.v/concat_sim_NMP.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_NMP.v/ccs_wrapper_NMP.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_NMP.v/concat_sim_NMP.v.vts ./scverify/ccs_wrapper_NMP.v/ccs_wrapper_NMP.v.vts
endif
...
$(TARGET)/concat_sim_NMP.v.vts: ./concat_sim_NMP.v
...
$(TARGET)/concat_sim_NMP.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
