# ----------------------------------------------------------------------------
# Concat concat_sim_GBCore Verilog
#
...
# Generated date: Wed Mar 18 19:14:09 PDT 2026
#
# ----------------------------------------------------------------------------
# ===================================================
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_GBCore
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = vcs
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_GBCore.v/concat_sim_GBCore.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_GBCore.v/ccs_wrapper_GBCore.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_GBCore.v/concat_sim_GBCore.v.vts ./scverify/ccs_wrapper_GBCore.v/ccs_wrapper_GBCore.v.vts
endif
...
$(TARGET)/concat_sim_GBCore.v.vts: ./concat_sim_GBCore.v
...
$(TARGET)/concat_sim_GBCore.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
