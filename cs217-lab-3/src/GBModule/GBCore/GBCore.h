...
#pragma hls_pipeline_init_interval 1
    while (1) {
      ...
      // CODE STARTS HERE =====================================================
      large_mem.run(
          large_read_addrs, large_read_req_valid,
          large_write_addrs, large_write_req_valid, large_write_data,
          large_read_ack, large_write_ack, large_read_ready,
          large_port_read_out, large_port_read_out_valid);
      // CODE ENDS HERE =======================================================
